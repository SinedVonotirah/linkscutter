...
<html>  
  <head>
    ...
    <spring:url value="/pages/res/signup.css" var="coreCss" />	
          ...
          <div class="col-md-12 text-center">          
            <form:form role="form" action="register" method="POST" commandName="userForm">
              <div class="form-group">
                ...
                <form:input path="login" class="form-control" id="exampleInputEmail1" placeholder="Enter Login"/>
              </div>
              <div class="form-group">
                <label class="control-label" for="exampleInputEmail1">Email</label>
                <form:input path="mail" class="form-control" id="exampleInputEmail1" placeholder="Enter Email" type="email"/>
              </div>
